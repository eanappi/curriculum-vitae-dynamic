...
const Layout = (page = []) => {
  const template = `
                        ...
                        <ul class="clearfix">
                            <li>
                                <div class="single-info d-flex align-items-center">
                                    ...
                                    <div class="info-text">
                                        <p><span>Date of birth:</span> ${page.birth}</p>
                                    </div>
                                </div> <!-- single info -->
                            </li>
                            <li>
    ...
    <section id="call-to-action" class="call-to-action pt-125 pb-130 bg_cover" style="background-image: url(${page.callToActionBackground})">
        <div class="container">
            <div class="row justify-content-center">
